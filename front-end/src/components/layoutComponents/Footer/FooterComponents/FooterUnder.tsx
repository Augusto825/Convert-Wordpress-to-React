...
const FooterUnder: React.FC = () => {
  return (
    <footer className="flex flex-col justify-center items-center  pt-px w-full text-sm leading-5 text-center text-white border-t border-solid bg-fuchsia-950 border-t-slate-400 border-t-opacity-20 max-w-[1920px] max-md:px-5 max-md:max-w-full">
